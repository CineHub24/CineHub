<script lang="ts">
    ...
    let filmDuration = selectedFilm.runtime;  // in Minuten
    let cleaningTime = 15;   // in Minuten
    let advertisementTime = 15; // in Minuten
    
    // Berechne die Gesamtdauer explizit aus allen Komponenten
    $: totalDuration = Number(filmDuration) + cleaningTime + advertisementTime;
    ...
    function isValidTime(time: string, start: string, end: string): boolean {
      ...
      // Prüfe ob die Zeit plus Gesamtdauer innerhalb des Zeitfensters liegt
  ...
  <div class="p-4">
    ...
    <!-- Erste Form für Zeitfenster-Suche -->
    <form method="POST" action="?/getTimeWindows" use:enhance class="mb-8 space-y-4">
      <div>
    ...
    {#if selectedTimeWindow}
      <div class="mb-8 p-4 border rounded bg-gray-50">
        ...
        <div class="space-y-4">
          <div>
            ...
            <p class="text-sm text-gray-600">
              ...
              <span class="text-xs text-gray-500">
                (Film: {formatDuration(filmDuration|| 0)}, 
          ...
          {#if isValidStartTime}
            <form method="POST" action="?/saveShowing" use:enhance>
