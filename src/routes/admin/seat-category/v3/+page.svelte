<script lang="ts">
    ...
    // Handle preset change for create form
    ...
    function startEditing(seatCategory) {
      ...
      const presetType =
        Object.entries(SEAT_PRESETS).find(
          ([, preset]) => preset.path(seatCategory.width, seatCategory.height) === seatCategory.customPath
        )?.[0] || 'regular';
  ...
  <div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
      {#if isCreatingNewSeatCategory}
        ...
        <div class="group relative overflow-hidden rounded-xl bg-white p-6 shadow-md transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
            ...
            <div class="grid grid-cols-3 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  oninput={(e) => updateDimensions('width', e.currentTarget.value)}
                  min="20"
                  class="w-full rounded-md border p-2"
                  required
                />
              ...
              <div>
                ...
                <input
                  ...
                  oninput={(e) => updateDimensions('height', e.currentTarget.value)}
                  min="20"
                  class="w-full rounded-md border p-2"
                  required
                />
